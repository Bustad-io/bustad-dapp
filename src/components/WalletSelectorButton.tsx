...
export function WalletSelectorButton({ walletLabel, isActive, logoPath, onClick }: Props) {
    return (
        <div onClick={onClick} className={`${isActive && 'outline outline-white outline-2'} inline-flex justify-center bg-Tuscanyapprox py-2 rounded-md cursor-pointer items-center min-w-[8rem] dialog:min-w-[11rem]`}>
