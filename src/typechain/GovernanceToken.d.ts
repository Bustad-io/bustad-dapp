...
interface GovernanceTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "SNAPSHOTER_ROLE()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "SNAPSHOTER_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class GovernanceToken extends BaseContract {
  ...
  functions: {
    ...
    SNAPSHOTER_ROLE(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    SNAPSHOTER_ROLE(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    SNAPSHOTER_ROLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
