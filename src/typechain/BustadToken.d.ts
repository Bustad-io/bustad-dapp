...
interface BustadTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "calculateMintingFee(uint256)": FunctionFragment;
...
export class BustadToken extends BaseContract {
  ...
  interface: BustadTokenInterface;
